...
export const serviceClient = {
	create: async (data: ServiceApi.Create.Request): Promise<ServiceApi.Create.Response> => {
		const response = await apiClient.post<ServiceApi.Create.Response>(
			APICONSTANTS.SERVICES.CREATE,
			data
		)
	...
	getById: async (serviceId: string): Promise<ServiceApi.GetService.Response> => {
		const response = await apiClient.get<ServiceApi.GetService.Response>(
			APICONSTANTS.SERVICES.GET_BY_ID(serviceId)
		)
		return response.data
	},

	getByBusiness: async (businessId: string): Promise<ServiceApi.GetServicesByBusiness.Response> => {
		const response = await apiClient.get<ServiceApi.GetServicesByBusiness.Response>(
			APICONSTANTS.SERVICES.GET_BY_BUSINESS(businessId)
		)
		return response.data
	},
