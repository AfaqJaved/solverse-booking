...
@Injectable()
export class DeactivateServiceUsecaseImpl implements DeactivateServiceUsecase {
  ...
  > {
    return Effect.gen(this, function* () {
      ...
      const userId = yield* decodeOrFail(UserId)(updatedBy)
      const updatedService = yield* service.deactivate(userId)
