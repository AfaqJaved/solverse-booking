        ...
        properties: {
          ...
          data: {
            ...
            properties: {
              ...
              email: { type: 'string', format: 'email', example: 'contact@acmesalon.com' },
              phone: { type: 'string', nullable: true, example: '+12025551234' },
    ...
    ApiBadRequestResponse({
      ...
      schema: {
        properties: {
          ...
          message: { type: 'string', example: 'Invalid input: businessId must be a valid UUID' },
          path: { type: 'string', example: '/businesses/:businessId' },
          timestamp: { type: 'string', format: 'date-time' },
        },
      },
