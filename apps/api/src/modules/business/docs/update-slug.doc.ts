...
export const UpdateBusinessSlugDoc = () =>
  applyDecorators(
    ApiOperation({
      ...
      description:
        'Changes the public booking URL slug. The new slug must be unique.',
    }),
    ApiParam({
      name: 'businessId',
      format: 'uuid',
    ...
    ApiConflictResponse({
      ...
      schema: {
        properties: {
          ...
          message: {
            type: 'string',
            example: 'Slug "new-slug" is already taken',
          },
    ...
    ApiBadRequestResponse({
      ...
      schema: {
        properties: {
          ...
          message: {
            type: 'string',
            example: 'Cannot update the slug of a deleted business',
          },
          path: { type: 'string', example: '/businesses/:businessId/slug' },
          timestamp: { type: 'string', format: 'date-time' },
        },
